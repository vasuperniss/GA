...
def train_classifier(train_set, dev_set, num_iterations, learning_rate, model, regularization):
...
if __name__ == '__main__':
    ...
    train_classifier(train_set, dev_set, num_iterations=20, learning_rate=0.01, model=model, regularization=1e-6)
